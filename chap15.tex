...
In a sense, the rate function is answering a hypothetical question: ``{\tt em If} the state at a particular time has these particular values, what {\em would} the slope be''.
