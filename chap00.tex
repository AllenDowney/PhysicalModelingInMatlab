...
I also assume you know basic physics, in particular the concepts of force, acceleration, velocity, and position.  If you know Newton's second law of motion in the form $F = m a$, that's enough.
...
\begin{description}
\item [Chapter 1: Modeling and Simulation] . . .
\item [Chapter 2: Scripts] . . .
\item [Chapter 3: Loops] . . .
...
However, as you add more folders to the path, you are more likely to run into problems with name collisions (see Section~\ref{collision}).
