...
In the next chapter we'll continue with the baseball example, using {\tt fzero}, which we saw in Chapter~\ref{fzero}, and a new tool for optimization, called {\tt fminsearch}.  We'll also see a simple way to animate the solution of a differential equation.
