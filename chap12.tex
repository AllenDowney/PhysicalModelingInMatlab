...
Physics of Baseball} by Robert K. Adair; the figure you need is reproduced at \url{https://github.com/AllenDowney/PhysicalModelingInMatlab/blob/master/code/data/baseball_drag.png}.
