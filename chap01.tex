...
\begin{figure}[h]
  \includegraphics{book/images/figure01_01_new.eps} 
  \index{modeling}
...
Comparing the results of successive models provides a form of \emph{internal \linebreak validation} so you can catch conceptual, mathematical, and software errors.  And by adding and removing features, you can tell which ones have the biggest effect on the results, and which can be ignored.
...
line between \lstinline{ans =} and the result.  In my examples I'll leave it out to \linebreak save room.
...
It also introduced MATLAB, the programming language we'll use to write simulations.  So far, we've seen variables and values, arithmetic operations, and mathematical functions.  At the end of the chapter you'll find exercises you can use to test your knowledge.
