...
If you discover an error in this book or the supporting code, or you have suggestions for improving them, please send them to \emph{downey@greenteapress.com}. Or, if you are a GitHub user, you can open an issue or a pull request at \url{https://github.com/AllenDowney/PhysicalModelingInMATLAB}.
